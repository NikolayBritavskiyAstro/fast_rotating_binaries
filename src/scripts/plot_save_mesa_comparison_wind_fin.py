...
paths = Paths()
if os.path.exists(os.path.join(paths.data, 'one_star/M24_ST/LOGS50/history.data')):
    pass
else:
...
plt.plot(star_age_50[0:iRLOF_50] / 1e6, surf_avg_vtor_50[0:iRLOF_50],
         label='$\it{v}^\mathrm{ini}_\mathrm{rot}$=50 $km~s^{-1}$', c=colors_list[1], lw=3)
...
plt.plot(star_age_100[0:iRLOF_100] / 1e6, surf_avg_vtor_100[0:iRLOF_100],
         label='$\it{v}^\mathrm{ini}_\mathrm{rot}$=100 $km~s^{-1}$', c=colors_list[2], lw=3)
plt.plot(star_age_200[0:iRLOF_200] / 1e6, surf_avg_vtor_200[0:iRLOF_200],
         label='$\it{v}^\mathrm{ini}_\mathrm{rot}$=200 $km~s^{-1}$', c=colors_list[3], lw=3)
...
plt.plot(star_age_300[0:iRLOF_300] / 1e6, surf_avg_vtor_300[0:iRLOF_300], linestyle='-', c=colors_list[4],
         label='$\it{v}^\mathrm{ini}_\mathrm{rot}$=300 $km~s^{-1}$', lw=3)

plt.plot(star_age_350[0:iRLOF_350] / 1e6, surf_avg_vtor_350[0:iRLOF_350], linestyle='-',
         label='$\it{v}^\mathrm{ini}_\mathrm{rot}$=350 $km~s^{-1}$', lw=3, c=colors_list[5])

plt.plot(star_age_50_st / 1e6, surf_avg_vtor_50_st, c=colors_list[1], linestyle='-.', lw=2, label='AM (no S-T dynamo)')
plt.plot(star_age_100_st[0:iRLOF_100_st] / 1e6, surf_avg_vtor_100_st[0:iRLOF_100_st], c=colors_list[2], linestyle='-.',
         lw=2)
plt.plot(star_age_200_st[0:iRLOF_200_st] / 1e6, surf_avg_vtor_200_st[0:iRLOF_200_st], c=colors_list[3], linestyle='-.',
         lw=2)
plt.plot(star_age_300_st[0:iRLOF_300_st] / 1e6, surf_avg_vtor_300_st[0:iRLOF_300_st], c=colors_list[4], linestyle='-.',
         lw=2)
plt.plot(star_age_350_st[0:iRLOF_350_st] / 1e6, surf_avg_vtor_350_st[0:iRLOF_350_st], c=colors_list[5], linestyle='-.',
         lw=2)
...
plt.plot(star_age_50_b[0:iRLOF_50_b] / 1e6, surf_avg_vtor_50_b[0:iRLOF_50_b], label='Wind (Bjorklund+23)',
         c=colors_list[1], linestyle='--', lw=2)
plt.plot(star_age_100_b[0:iRLOF_100_b] / 1e6, surf_avg_vtor_100_b[0:iRLOF_100_b], c=colors_list[2], linestyle='--',
         lw=2)
plt.plot(star_age_200_b[0:iRLOF_200_b] / 1e6, surf_avg_vtor_200_b[0:iRLOF_200_b], c=colors_list[3], linestyle='--',
         lw=2)
plt.plot(star_age_300_b[0:iRLOF_300_b] / 1e6, surf_avg_vtor_300_b[0:iRLOF_300_b], c=colors_list[4], linestyle='--',
         lw=2)
# plt.plot(star_age_350_b[0:iRLOF_350_b]/1e6, surf_avg_vtor_350_b[0:iRLOF_350_b],c='gray',linestyle='--',lw=1)
plt.plot(star_age_340_b[0:iRLOF_340_b] / 1e6, surf_avg_vtor_340_b[0:iRLOF_340_b], c=colors_list[5], linestyle='--',
         lw=2)
...
plt.plot(10 ** log_Teff_200 / 1000, LOGL_200, linestyle='-',
         label='$\it{v}^\mathrm{ini}_\mathrm{rot}$=200 $km~s^{-1}$, mesh delta=1, time delta=1', lw=1, c=colors_list[3])
...
plt.plot(10 ** log_Teff_1[0:iRLOF_1] / 1000, LOGL_1[0:iRLOF_1], linestyle='--', color='red', lw=8,
         label='$\it{v}^\mathrm{ini}_\mathrm{rot}$=200 $km~s^{-1}$, mesh delta=0.5, time delta=0.75')
...
plt.figure(figsize=(10, 10))
plt.title("$\it{M}_\mathrm{ini}$ = 24 $\it{M}_\mathrm{\odot}$", fontsize=30)
plt.plot(star_age_1[0:iRLOF_1] / 1e6, surf_avg_vtor_1[0:iRLOF_1], color='red',
         label='$\it{v}^\mathrm{ini}_\mathrm{rot}$=200 $km~s^{-1}$, mesh delta=0.5, time delta=0.75', lw=8,
         linestyle='--')
# plt.plot(star_age_1[iRLOF_1]/1e6, surf_avg_vtor_1[iRLOF_1],color='red',lw=5,linestyle='-')

plt.plot(star_age_200[0:iRLOF_200] / 1e6, surf_avg_vtor_200[0:iRLOF_200],
         label='$\it{v}^\mathrm{ini}_\mathrm{rot}$=200 $km~s^{-1}$, mesh delta=1, time delta=1', c=colors_list[3])
