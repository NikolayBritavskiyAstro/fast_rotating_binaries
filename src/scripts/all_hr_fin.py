...
ax1.plot(age_230[i_pre_RLOF_230]/1e6, period_230[i_pre_RLOF_230],linestyle='-',label='$\it{v}^\mathrm{1,ini}_\mathrm{rot}$ = 230 $km~s^{-1}$',lw=2,c= colors_list[0])
ax1.scatter(age_230[iRLOF_1_230][0]/1e6, period_230[iRLOF_1_230][0], marker='x',  c='k',s=100)


ax1.plot(age_200[i_pre_RLOF_200]/1e6, period_200[i_pre_RLOF_200],linestyle='-',label='$\it{v}^\mathrm{1,ini}_\mathrm{rot}$ = 200 $km~s^{-1}$',lw=2,c= colors_list[1])
...
ax1.plot(age_150[i_pre_RLOF_150]/1e6, period_150[i_pre_RLOF_150],linestyle='-',label='$\it{v}^\mathrm{1,ini}_\mathrm{rot}$= 150 $km~s^{-1}$',lw=2,c= colors_list[2])
...
ax1.plot(age_100[i_pre_RLOF_100]/1e6, period_100[i_pre_RLOF_100],linestyle='-',label='$\it{v}^\mathrm{1,ini}_\mathrm{rot}$ = 100 $km~s^{-1}$',lw=2,c= colors_list[3])
...
ax1.plot(age_50[i_pre_RLOF_50]/1e6, period_50[i_pre_RLOF_50],linestyle='-',label='$\it{v}^\mathrm{1,ini}_\mathrm{rot}$ = 50 $km~s^{-1}$',lw=2,c= colors_list[4])
...
ax1.plot(age_1[i_pre_RLOF_1]/1e6, period_1[i_pre_RLOF_1],linestyle='-',label='$\it{v}^\mathrm{1,ini}_\mathrm{rot}$ = 1 $km~s^{-1}$',lw=2,c= colors_list[5])
ax1.scatter(age_1[iRLOF_1_1][0]/1e6, period_1[iRLOF_1_1][0], marker='o', c='k',s=100)

ax1.plot(age_1_nt[i_pre_RLOF_1_nt]/1e6, period_1_nt[i_pre_RLOF_1_nt],linestyle='--',label='$\it{v}^\mathrm{1,ini}_\mathrm{rot}$ = 1 $km~s^{-1}$, no tides',lw=2, color = 'orange')
ax1.scatter(age_1_nt[iRLOF_1_1_nt][0]/1e6, period_1_nt[iRLOF_1_1_nt][0], marker='x', c='orange',s=100)

ax1.plot(age_1_s[i_pre_RLOF_1_s]/1e6, period_1_s[i_pre_RLOF_1_s],linestyle='--',label='initially synchronized',lw=2, color = 'red')
...
ax1.plot([star_age_230[indMS_230][-1]/1e6, star_age_200[indMS_200][-1]/1e6],[period_230[star_age_ms_ind_230], period_200[star_age_ms_ind_200]],linestyle='--',color='gray')

ax1.plot([star_age_200[indMS_200][-1]/1e6, star_age_150[indMS_150][-1]/1e6],[period_200[star_age_ms_ind_200], period_150[star_age_ms_ind_150]],linestyle='--',color='gray')

ax1.plot([star_age_150[indMS_150][-1]/1e6, star_age_100[indMS_100][-1]/1e6],[period_150[star_age_ms_ind_150], period_100[star_age_ms_ind_100]],linestyle='--',color='gray')

ax1.plot([star_age_100[indMS_100][-1]/1e6, star_age_50[indMS_50][-1]/1e6],[period_100[star_age_ms_ind_100], period_50[star_age_ms_ind_50]],linestyle='--',color='gray')
