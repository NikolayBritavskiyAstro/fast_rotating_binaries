...
ax1.set_title('HD46485, $\it{v}^\mathrm{ini}_\mathrm{rot}$=350 $km~s^{-1}$, $\it{M}_\mathrm{1,ini}$=24, $\it{M}_\mathrm{2,ini}$=1, $\it{P}_\mathrm{ini}$=6.9 d', fontdict={'fontsize': 17, 'fontweight': 'medium'})
...
ax2.set_title('HD191495, $\it{v}^\mathrm{ini}_\mathrm{rot}$=200 $km~s^{-1}$, $\it{M}_\mathrm{1,ini}$=15, $\it{M}_\mathrm{2,ini}$=1.5, $\it{P}_\mathrm{ini}$=3.6 d', fontdict={'fontsize': 17, 'fontweight': 'medium'})
...
ax3.set_title('HD25631, $\it{v}^\mathrm{ini}_\mathrm{rot}$=220 $km~s^{-1}$, $\it{M}_\mathrm{1,ini}$=7, $\it{M}_\mathrm{2,ini}$=1, $\it{P}_\mathrm{ini}$=5.2 d', fontdict={'fontsize': 17, 'fontweight': 'medium'})
