...
ax1.set_title(
    'HD46485, $\it{v}^\mathrm{1,ini}_\mathrm{rot}$=1 $km~s^{-1}$, $\it{M}_\mathrm{1,ini}$=24, $\it{M}_\mathrm{2,ini}$=1, $\it{P}_\mathrm{ini}$=6.9 d',
...
ax2.set_title(
    'HD191495, $\it{v}^\mathrm{1,ini}_\mathrm{rot}$=1 $km~s^{-1}$, $\it{M}_\mathrm{1,ini}$=15, $\it{M}_\mathrm{2,ini}$=1.5, $\it{P}_\mathrm{ini}$=3.6 d',
    fontdict={'fontsize': 17, 'fontweight': 'medium'})
...
ax3.set_title(
    'HD25631, $\it{v}^\mathrm{1,ini}_\mathrm{rot}$=1 $km~s^{-1}$, $\it{M}_\mathrm{1,ini}$=7, $\it{M}_\mathrm{2,ini}$=1, $\it{P}_\mathrm{ini}$=5.2 d',
    fontdict={'fontsize': 17, 'fontweight': 'medium'})
...
plt.plot(star_age_200_46_newtides / 1e6, surf_avg_omega200_46_newtides * param, linestyle='--', color='b',
         label='POSYDON')
...
plt.plot(age_200_46 / 1e6, v_sync_46 / star_1_radius200_46 / rsun * param, '-.', color='gray',
         label='$\it{\omega}_\mathrm{sync}$')
...
plt.plot(star_age_200_191_newtides / 1e6, surf_avg_omega200_191_newtides * param, linestyle='--', color='b',
         label='POSYDON')

plt.plot(star_age_200_nowind_191 / 1e6, surf_avg_omega200_nowind_191 * param, linestyle='-.', color='r',
         label='No tides')

# plt.plot(star_age_200_191/1e6, surf_avg_omega_crit200_191,'--',color='gray',label='$\omega_{crit}$')
plt.plot(age_200_191 / 1e6, v_sync_191 / star_1_radius200_191 / rsun * param, '-.', color='gray',
         label='$\it{\omega}_\mathrm{sync}$')
...
plt.plot(star_age_200_25_newtides / 1e6, surf_avg_omega200_25_newtides * param, linestyle='--', color='b',
         label='POSYDON')
...
plt.plot(age_200_25 / 1e6, v_sync_25 / star_1_radius200_25 / rsun * param, '-.', color='gray',
         label='$\it{\omega}_\mathrm{sync}$')
