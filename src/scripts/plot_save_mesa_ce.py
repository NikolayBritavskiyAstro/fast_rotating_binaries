...
ORB_E = G_cgs * mass_profile * star_2_mass_HD * Msun ** 2 / (2 * r_profile * Rsun_cm) - (
            G_cgs * star_1_mass_HD * star_2_mass_HD * Msun ** 2) / (2 * binary_separation_HD * Rsun_cm)

ORB_E_pos = G_cgs * mass_profile_pos * star_2_mass_HD_pos * Msun ** 2 / (2 * r_profile_pos * Rsun_cm) - (
            G_cgs * star_1_mass_HD_pos * star_2_mass_HD_pos * Msun ** 2) / (2 * binary_separation_HD_pos * Rsun_cm)
...
ax1.plot(profile_fin.prof.radius[:-50], BE_1[:-50] / ORB_E[:-50], c='b', linestyle='-',
         label=r'$\alpha_\mathrm{th}$=1, MESA default')
ax1.plot(profile_fin.prof.radius[:-50], BE_0[:-50] / ORB_E[:-50], c='r', linestyle='-',
         label=r'$\alpha_\mathrm{th}$=0, MESA default')
ax1.plot(profile_fin_pos.prof.radius[:-50], BE_1_pos[:-50] / ORB_E_pos[:-50], c='green', linestyle='-',
         label=r'$\alpha_\mathrm{th}$=1, POSYDON')
...
ax3.plot(profile_fin.prof.radius, BE_0 / ORB_E, c='r', linestyle='-', lw=2,
         label=r'$\alpha_\mathrm{th}$=0, MESA default')
ax3.plot(profile_fin_pos.prof.radius, BE_1_pos / ORB_E_pos, c='green', linestyle='-', lw=2,
         label=r'$\alpha_\mathrm{th}$, POSYDON')
# ax3.plot(profile_fin_pos.data('radius'), BE_0_pos/ORB_E_pos, c='black',linestyle='-', lw=2 ,label='alpha_th=1, alpha_rot=1, posydon')
