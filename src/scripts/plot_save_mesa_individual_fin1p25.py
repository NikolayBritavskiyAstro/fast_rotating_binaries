...
plt.plot(star_2_mass/star_1_mass,period_class,color='k',linestyle='-',label='MESA default, $\it{\gamma}$ = 0',lw=2)
plt.plot(star_2_mass[iRLOF_1]/star_1_mass[iRLOF_1],period_class[iRLOF_1], lw=7, c='k')


plt.plot(star_2_mass_g1_new/star_1_mass_g1_new, period_class_g1_new,label='MESA default, $\it{\gamma}$ = 1',lw=2,linestyle='-',color='orange')
...
plt.plot(star_2_mass_g1_new[iRLOF_1_g1_new]/star_1_mass_g1_new[iRLOF_1_g1_new],period_class_g1_new[iRLOF_1_g1_new], lw=7,linestyle='-',color='orange')


plt.plot(star_2_mass_g2_new/star_1_mass_g2_new, period_class_g2_new,label='MESA default, $\it{\gamma}$ = 2',lw=2,linestyle='-',color='blue')
plt.plot(star_2_mass_g2_new[iRLOF_1_g2_new]/star_1_mass_g2_new[iRLOF_1_g2_new],period_class_g2_new[iRLOF_1_g2_new], lw=7,linestyle='-',color='blue')

plt.plot(star_2_mass_g10_new/star_1_mass_g10_new, period_class_g10_new,label='MESA default, $\it{\gamma}$ = 10',lw=2,linestyle='-',color='red')
plt.plot(star_2_mass_g10_new[iRLOF_1_g10_new]/star_1_mass_g10_new[iRLOF_1_g10_new],period_class_g10_new[iRLOF_1_g10_new], lw=7,linestyle='-',color='red')



plt.plot( star_2_mass_posydon/star_1_mass_posydon,period_posydon,linestyle='-',label='POSYDON, $\it{\gamma}$ = 0',color='green',lw=2)
plt.plot( star_2_mass_posydon[iRLOF_1_posydon]/star_1_mass_posydon[iRLOF_1_posydon],period_posydon[iRLOF_1_posydon], lw=7, c='green')
...
if any(iRLOF_2) == True:
   ...
   plt.plot(star_2_mass[0:indx1]/star_1_mass[0:indx1],period_class[0:indx1],color='k',linestyle='-',label='MESA default, $\it{\gamma}$ = 0',lw=2)
...
if any(iRLOF_2_g1_new) == True:
   ...
   plt.plot(star_2_mass_g1_new[0:indx1]/star_1_mass_g1_new[0:indx1],period_class_g1_new[0:indx1],color='orange',linestyle='-',label='MESA default, $\it{\gamma}$ = 1',lw=2)
   plt.plot(star_2_mass_g1_new[indx1:indx2]/star_1_mass_g1_new[indx1:indx2],period_class_g1_new[indx1:indx2], lw=7, c='orange')
   plt.plot(star_2_mass_g1_new[indx2]/star_1_mass_g1_new[indx2],period_class_g1_new[indx2], marker='o', c='orange', mfc = 'orange', ms = 25)
...
if any(iRLOF_2_g2_new) == True:
   ...
   plt.plot(star_2_mass_g2_new[0:indx1]/star_1_mass_g2_new[0:indx1],period_class_g2_new[0:indx1],color='blue',linestyle='-',label='MESA default, $\it{\gamma}$ = 2',lw=2)
   plt.plot(star_2_mass_g2_new[indx1:indx2]/star_1_mass_g2_new[indx1:indx2],period_class_g2_new[indx1:indx2], lw=7, c='blue')
   plt.plot(star_2_mass_g2_new[indx2]/star_1_mass_g2_new[indx2],period_class_g2_new[indx2], marker='o', c='blue', mfc = 'blue', ms = 25)
...
if any(iRLOF_2_g10_new) == True:
   ...
   plt.plot(star_2_mass_g10_new[0:indx1]/star_1_mass_g10_new[0:indx1],period_class_g10_new[0:indx1],color='red',linestyle='-',label='MESA default, $\it{\gamma}$ = 10',lw=2)
   plt.plot(star_2_mass_g10_new[indx1:indx2]/star_1_mass_g10_new[indx1:indx2],period_class_g10_new[indx1:indx2], lw=7, c='red')
   plt.plot(star_2_mass_g10_new[indx2]/star_1_mass[indx2],period_class_g10_new[indx2], marker='o', c='red', mfc = 'red', ms = 25)
...
if any(iRLOF_2_posydon) == True:
   ...
   plt.plot(star_2_mass_posydon[0:indx1]/star_1_mass_posydon[0:indx1],period_posydon[0:indx1],color='green',linestyle='-',label='POSYDON, $\it{\gamma}$ = 0',lw=2)
   plt.plot(star_2_mass_posydon[indx1:indx2]/star_1_mass_posydon[indx1:indx2],period_posydon[indx1:indx2], lw=7, c='green')
   plt.plot(star_2_mass_posydon[indx2]/star_1_mass_posydon[indx2],period_posydon[indx2], marker='o', c='green', mfc = 'green', ms = 25)
