...
stable_tides_200_46_newtides_str = [3 * el for el in
                                    np.add(star_1_J_spin_200_46_newtides_str, star_2_J_spin_200_46_newtides_str)]
...
stable_tides_200_20_newtides_str = [3 * el for el in
                                    np.add(star_1_J_spin_200_25_newtides_str, star_2_J_spin_200_25_newtides_str)]
...
plt.title(
    'HD46485, $\it{v}^\mathrm{1,ini}_\mathrm{rot}$=350 $km~s^{-1}$, $\it{M}_\mathrm{1,ini}$=24, $\it{M}_\mathrm{2,ini}$=1, $\it{P}_\mathrm{ini}$=6.9 d',
    fontsize=22)

plt.plot(star_age_200_46_newtides_str / 1e6, surf_avg_vtor_200_46_newtides_str, linestyle='-', color='black',
         label='POSYDON, mesh delta = 1, time delta = 1')

plt.plot(star_age_200_46_newtides_res04 / 1e6, surf_avg_vtor_200_46_newtides_res04, linestyle='--',
         label='POSYDON, mesh delta = 0.5, time delta = 0.75', color='red')
...
plt.plot(star_age_200_46_newtides_str / 1e6, surf_avg_vtor_200_46_newtides_str, linestyle='--', color='b',
         label='POSYDON')
...
ax2.set_title(
    'HD191495, $\it{v}^\mathrm{1,ini}_\mathrm{rot}$=200 $km~s^{-1}$, $\it{M}_\mathrm{1,ini}$=15, $\it{M}_\mathrm{2,ini}$=1.5, $\it{P}_\mathrm{ini}$=3.6 d',
    fontdict={'fontsize': 17, 'fontweight': 'medium'})
plt.plot(star_age_200_191 / 1e6, surf_avg_vtor_200_191, linestyle='-', color='black', label='MESA default')

plt.plot(star_age_200_191_newtides_str / 1e6, surf_avg_vtor_200_191_newtides_str, linestyle='--', color='b',
         label='POSYDON')
...
ax3.set_title(
    'HD25631, $\it{v}^\mathrm{1,ini}_\mathrm{rot}$=220 $km~s^{-1}$, $\it{M}_\mathrm{1,ini}$=7, $\it{M}_\mathrm{2,ini}$=1, $\it{P}_\mathrm{ini}$=5.2 d',
    fontdict={'fontsize': 17, 'fontweight': 'medium'})
plt.plot(star_age_200_25 / 1e6, surf_avg_vtor_200_25, linestyle='-', color='black', label='MESA default')

plt.plot(star_age_200_25_newtides_str / 1e6, surf_avg_vtor_200_25_newtides_str, linestyle='--', color='b',
         label='POSYDON')
...
plt.plot(10 ** (log_Teff_1_200_46_newtides) / 1000, LOGL_1_200_46_newtides, color='k', linestyle='-',
         label='POSYDON, mesh delta = 1, time delta = 1', lw=2)
...
plt.plot(10 ** (log_Teff_1_200_46_newtides_res04) / 1000, LOGL_1_200_46_newtides_res04, linestyle='--',
         label='POSYDON, mesh delta = 0.5, time delta = 0.75', color='red')
...
plt.plot(star_1_radius200_191_newtides_str[iRLOF_1_posydon], lg_t_sync_1_posydon[iRLOF_1_posydon], lw=5, c='b',
         zorder=0)
