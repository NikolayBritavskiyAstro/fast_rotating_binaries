...
def plot_min_a_in(observed_binary, fig_name=None, title=None):
    ...
    for f_dm in fracs:  # min a_out
        ...
        ax.text(0.95, 0.05, r"$f_\Delta=" + f"{f_dm}$", va="bottom", ha="right", fontsize=20, transform=ax.transAxes,
                bbox=dict(facecolor='w', alpha=0.5, edgecolor='black', boxstyle='round,pad=0.1'))
