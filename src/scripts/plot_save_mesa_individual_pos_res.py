...
plt.plot(star_2_mass/star_1_mass,period_class,color='k',linestyle='-',label='MESA default, mesh delta=1, time delta=1',lw=15)
...
plt.plot(star_2_mass_res/star_1_mass_res,period_class_res,color='red',linestyle='--',label='MESA default, mesh delta=0.5, time delta=0.75',lw=2)
plt.plot(star_2_mass_res[iRLOF_1_res]/star_1_mass_res[iRLOF_1_res],period_class_res[iRLOF_1_res], lw=4, c='red',linestyle='--')
...
plt.plot( star_2_mass_posydon/star_1_mass_posydon,period_posydon,linestyle='-',label='POSYDON, mesh delta=1, time delta=1',color='green',lw=12)
plt.plot( star_2_mass_posydon[iRLOF_1_posydon]/star_1_mass_posydon[iRLOF_1_posydon],period_posydon[iRLOF_1_posydon], lw=17, c='green')





plt.plot( star_2_mass_posydon_res/star_1_mass_posydon_res,period_posydon_res,linestyle='--',label='POSYDON, mesh delta=0.5, time delta=0.75',color='magenta')
plt.plot( star_2_mass_posydon_res[iRLOF_1_posydon_res]/star_1_mass_posydon_res[iRLOF_1_posydon_res],period_posydon_res[iRLOF_1_posydon_res], lw=5, c='magenta',linestyle='--')
