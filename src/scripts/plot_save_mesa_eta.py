...
plt.title('$\it{M}_\mathrm{don,ini}$ = 30, $\it{M}_\mathrm{acc,ini}$ = 20, $\it{\gamma}$ = 3',
          fontsize=30)  # plt.tick_params(labelsize=18)
...
plt.plot(surf_avg_omega_div_omega_crit_p3_g1_new[indx_p3][:-150], 1 - delta_p3_g1_new[:-150],
...
plt.plot(surf_avg_omega_div_omega_crit_p10_g1_new[indx_p10], 1 - delta_p10_g1_new, linestyle='-',
...
plt.plot(surf_avg_omega_div_omega_crit_p70_g1_new[indx_p70][:-30], 1 - delta_p70_g1_new[:-30], linestyle='-',
